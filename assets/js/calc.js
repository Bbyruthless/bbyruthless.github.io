...
electronicsPrice.addEventListener('input', updateTotals);
glassQuantity.addEventListener('input', updateTotals);
glassPrice.addEventListener('input', updateTotals);
plasticQuantity.addEventListener('input', updateTotals);
plasticPrice.addEventListener('input', updateTotals);
rubberQuantity.addEventListener('input', updateTotals);
rubberPrice.addEventListener('input', updateTotals);
scrapQuantity.addEventListener('input', updateTotals);
scrapPrice.addEventListener('input', updateTotals);
steelQuantity.addEventListener('input', updateTotals);
steelPrice.addEventListener('input', updateTotals);
woodQuantity.addEventListener('input', updateTotals);
woodPrice.addEventListener('input', updateTotals);
